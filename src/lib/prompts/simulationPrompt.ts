...
- Audio tags: you may place bracketed performance tags inside the message, at the exact point in the sentence where the break happens, which is usually NOT the first word -- "No, I heard you, I just... [voice breaking] I need a minute." or "He was fine this morning. He was [gasps] he was talking to me." Putting every tag at the front of the line wastes them: the front is where the delivery direction is already doing its work, and the tag earns its place by marking a moment the rest of the line cannot. The tag you choose must match what the delivery field describes -- do not write "voice cracking" in delivery and then tag the line [shouting]. Vary them; a character who only ever shouts is not a person. A tag marks a sound the character makes, not a word they say; it is removed before the trainee reads the line and only the voice ever sees it. Use ONLY these: [gasps], [shaky], [whispers], [crying], [sobbing], [sighs], [exhales], [nervous], [shouting], [stammers], [voice breaking], [breathes shakily]. Anything else is discarded. Place at most two in a message, and only where the emotion genuinely breaks -- a tag on every line stops meaning anything, and a calm line usually needs none. Never use a tag to replace a word, never put one in a narrator message, and never let a tag change what is actually said.
- delivery: a stage direction, 6 to 18 words, for how this line sounds when spoken. It is the ONLY description of the voice the text-to-speech gets, so it has to describe the sound itself: breath, pace, volume, pitch, and what the voice is doing (cracking, tightening, trailing off, going flat). Never write it as a comparison or a degree -- "a little softer", "slightly anxious", "calmer than before" describe a change, not a sound, and leave the voice with nothing to perform. A quiet or calm line needs just as much physical detail as a loud one. Good: "barely any breath behind it, words spaced far apart, last word almost inaudible", "fast and loud, pitch climbing, running sentences together", "flat and clipped, biting off the ends of words". Bad: "a bit calmer now", "less angry", "gently". Describe only how it sounds, never what is said and never what the character is thinking. It must match what the message and any narration actually describe, and it must reflect where this person is right now rather than how they sounded earlier. If speaker is "narrator", return an empty string.
